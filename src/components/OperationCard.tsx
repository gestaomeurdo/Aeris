...
const OperationCard = ({ code, title, status, progress }: OperationCardProps) => {
  ...
  return (
    <div className="relative bg-zinc-900/40 backdrop-blur-xl border-l border-zinc-800/50 p-6 flex flex-col gap-6 group overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-3">
        {isLocked ? (
          <div className="col-span-3 flex items-center justify-center gap-2 p-8 border border-dashed border-zinc-800/50 rounded-md bg-black/40">
