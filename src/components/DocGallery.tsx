      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {docModules.map((mod, idx) => (
          <motion.div
            ...
            className={`relative aspect-[3/4] bg-black/40 border ${mod.locked ? 'border-red-500/20 opacity-60' : 'border-[#00E5FF]/20'} rounded-3xl overflow-hidden group p-6 flex flex-col justify-between transition-all`}
          >
